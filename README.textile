...
A simple graph stress tester based on the Pilot graph operator, utilizing the Tinkerpop stack -- i.e. Blueprints, Gremlin, Pipes. You can use it to:
...
bc. $ groovyc *.groovy
$ ./GraphTestManager.groovy <testdefinitionfile.xml>
